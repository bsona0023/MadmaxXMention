...
async def start(event):
    ...
    await event.client.send_file(
        event.chat_id,
        file="https://telegra.ph/file/25ead8ab2070e25ccbad5.jpg",
        caption="━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ ɪ ᴀᴍ ᴀʟᴇxᴀ ᴛᴏ ᴍᴇɴᴛɪᴏɴ ᴀʟʟ ᴛʜᴇ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀs ɪɴ ᴛᴇʟᴇɢʀᴀᴍ\n✪ ᴛʜᴀɴᴋs ғᴏʀ ᴜsɪɴɢ ʀᴜɴ /help..\n\n┏━━━━━━━━━━━━━━━━━┓\n┣★ ᴏᴡɴᴇʀ    : [MΔDMΔX](https://t.me/about_sashikant)\n┣★ ᴜᴘᴅᴀᴛᴇs › : [MΔDMΔX HΣLP](https://t.me/voiceofheart0)┓\n┣★ ʀᴇᴘᴏ › : [MΔDMΔX RΣPΩ](https://github.com/THEMADMAXPRO/MadmaxXMention)\n┗━━━━━━━━━━━━━━━━━┛\n\n💞 ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ\nᴅᴍ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](https://t.me/about_sashikant/3) ...\n\n━━━━━━━━━━━━━━━━━━━━━━━━",
        link_preview=False,
        buttons=[
            [Button.url("ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ", "https://t.me/Madmax_MentionBot?startgroup=true")],
            [Button.url("ɢʀᴏᴜᴘ", "https://t.me/voiceofheart0"), Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/statusdairy2")],
            [Button.url("ᴏᴡɴᴇʀ", "https://t.me/about_sashikant/3")]
        ]
    )
...
async def help(event):
    ...
    await event.reply(
        ...
        buttons=(
            [
                Button.url("ꜱᴜᴘᴘᴏʀᴛ", "https://t.me/voiceofheart0"),
...
async def help(event):
    ...
    if not event.is_private:
        return await event.respond("ᴅᴇᴀʀ sᴛᴀʀᴛ ᴍᴇ ɪɴ ᴘᴍ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴғ 🥺")
    helptext = "✪ ᴏᴡɴᴇʀ ᴍᴇɴᴜ ᴏғ ᴀʟᴇxᴀ ᴍᴇɴᴛɪᴏɴ\n\n✪ ᴍʏ ᴏᴡɴᴇʀ ɪs [ᴍᴀᴅᴍᴀx](https://t.me/ABOUT_SASHIKANT/3)\n✪ ᴏғғɪᴄɪᴀʟ ᴍᴇᴍʙᴇʀ ᴏғ [ᴛᴇᴀᴍ ᴍᴀᴅᴍᴀx](https://t.me/voiceofheart\n✪  [ᴄʜᴀɴɴᴇʟ](https://youtube.com/statusdairy2)\n✪ ғᴜᴛᴜʀᴇ ᴀɴᴇsᴛʜᴇᴛɪᴄ."
    await event.reply(
        helptext,
        link_preview=False,
        buttons=(
            [
                Button.url("ꜱᴜᴘᴘᴏʀᴛ", "https://t.me/voiceofheart0"),
                Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/statusdairy2"),
            ]
        ),
    )
...
print(">> ᴍᴀᴅᴍᴀx ᴍᴇɴᴛɪᴏɴ ʙᴏᴛ ᴡᴏʀᴋɪɴɢ <<")
